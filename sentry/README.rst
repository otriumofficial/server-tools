This module is based on the Sentry integration module for Odoo 16 provided by OCA. Changes have been made to backport it so it can run on Odoo 11.

See: https://github.com/OCA/server-tools/tree/16.0

======
Changes from OCA module.
======

* Patched Sentry middleware into `odoo.service.wsgi_server`
* Removed Sentry log message to say Odoo was up and running
* Use git tag name as release identifier rather than commit hash
* Set unit tests to run post install
